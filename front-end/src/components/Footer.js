    ...
    return (
        <div>
            <div className="container my-5">
                <footer className="text-center text-lg-start text-dark" style={{ backgroundColor: "cyan-blue" }}>
                    <section
                        className="d-flex justify-content-between p-4 text-white"
                        style={{ backgroundColor: "green-cyan" }} >
                        <div className="me-5">
                        ...
                        <div>
                            ...
                            <a href="https://www.linkedin.com/feed/" className="text-white me-4">
                            ...
                            <div className="row mt-3">
                                ...
                                <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                                    ...
                                    <hr
                                        ...
                                        style={{ width: "60px", backgroundColor: "blue", height: "2px" }} />
                                    <p>
