...
export default function SaleProducts() {
    ...
    const onSaleMale = product.filter((data) => data.promotion.onSale === true);
    return (
                ...
                onSaleMale.map((data) => (
                    <Card className="card_c" key={data.id}>
                        <div className="card_img_main">
                            <Card.Img className="card_img" variant="top" src={`assets/sale/${data.src}`} />
                        </div>
                        <Card.Body>
                            ...
                            <Card.Text>
                                <span className='card_discount'>
                                    {(data.promotion.onSale === true ? data.promotion.discount + '% Discount' : '')}
                                </span>
                            </Card.Text>
